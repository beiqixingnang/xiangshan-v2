...
int main(int argc, char **argv) {
  ...
  dut.reset = 1; dut.clk = 0; dut.eval(); dut.clk = 1; dut.eval(); dut.clk = 0; dut.reset = 0;
  ...
  for (unsigned i=0;i<sizeof(v)/sizeof(v[0]);++i) {
    dut.io_in_valid=v[i][0]; dut.io_in_bits=v[i][1]; dut.io_out_ready=v[i][2]; dut.io_rightOutFire=v[i][3]; dut.io_isFlush=v[i][4]; dut.io_isOlder=0; dut.reset=0; dut.clk=0; dut.eval();
