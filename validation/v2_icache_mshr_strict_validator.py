"""Prove both locked V2 ICacheMSHR specializations with complete equivalence."""
...
BUILD = ROOT / (
    ...
    "Build-Cpu.Frontend.Icache.ICacheMshr-Hardware.py"
)
...
def main() -> int:
    """Run the two-variant proof and persist independently hashed evidence."""
    ...
    if validator_pyright.get("status") != "PASS":
        payload["failures"].append("ICacheMSHR validator pyright")
