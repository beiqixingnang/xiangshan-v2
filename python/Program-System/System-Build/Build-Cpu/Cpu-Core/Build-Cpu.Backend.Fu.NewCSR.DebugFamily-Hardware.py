...
PORT_SPECS: dict[str, tuple[PortSpec, ...]] = {
    'Debug': (
        ('clock', 'input', 1),
        ('io_in_trapInfo_valid', 'input', 1),
        ('io_in_trapInfo_bits_trapVec', 'input', 64),
        ('io_in_trapInfo_bits_isDebugIntr', 'input', 1),
        ('io_in_trapInfo_bits_isInterrupt', 'input', 1),
        ('io_in_trapInfo_bits_singleStep', 'input', 1),
        ('io_in_trapInfo_bits_trigger', 'input', 4),
        ('io_in_trapInfo_bits_criticalErrorState', 'input', 1),
        ('io_in_privState_PRVM', 'input', 2),
        ('io_in_privState_V', 'input', 1),
        ('io_in_debugMode', 'input', 1),
        ('io_in_dcsr_CETRIG', 'input', 1),
        ('io_in_dcsr_EBREAKVS', 'input', 1),
        ('io_in_dcsr_EBREAKVU', 'input', 1),
        ('io_in_dcsr_EBREAKM', 'input', 1),
        ('io_in_dcsr_EBREAKS', 'input', 1),
        ('io_in_dcsr_EBREAKU', 'input', 1),
        ('io_in_tselect_ALL', 'input', 2),
        ('io_in_tdata1Selected_DATA', 'input', 59),
        ('io_in_tdata2Selected_ALL', 'input', 64),
        ('io_in_tdata1Vec_0_TYPE', 'input', 4),
        ('io_in_tdata1Vec_0_DATA', 'input', 59),
        ('io_in_tdata1Vec_1_TYPE', 'input', 4),
        ('io_in_tdata1Vec_1_DATA', 'input', 59),
        ('io_in_tdata1Vec_2_TYPE', 'input', 4),
        ('io_in_tdata1Vec_2_DATA', 'input', 59),
        ('io_in_tdata1Vec_3_TYPE', 'input', 4),
        ('io_in_tdata1Vec_3_DATA', 'input', 59),
        ('io_in_triggerCanRaiseBpExp', 'input', 1),
        ('io_in_tdata1Update', 'input', 1),
        ('io_in_tdata2Update', 'input', 1),
        ('io_in_tdata1Wdata_TYPE', 'input', 4),
        ('io_in_tdata1Wdata_DATA', 'input', 59),
        ('io_out_triggerFrontendChange', 'output', 1),
        ('io_out_newTriggerChainIsLegal', 'output', 1),
        ('io_out_memTrigger_tUpdate_valid', 'output', 1),
        ('io_out_memTrigger_tUpdate_bits_addr', 'output', 2),
        ('io_out_memTrigger_tUpdate_bits_tdata_matchType', 'output', 2),
        ('io_out_memTrigger_tUpdate_bits_tdata_select', 'output', 1),
        ('io_out_memTrigger_tUpdate_bits_tdata_action', 'output', 4),
        ('io_out_memTrigger_tUpdate_bits_tdata_chain', 'output', 1),
        ('io_out_memTrigger_tUpdate_bits_tdata_store', 'output', 1),
        ('io_out_memTrigger_tUpdate_bits_tdata_load', 'output', 1),
        ('io_out_memTrigger_tUpdate_bits_tdata_tdata2', 'output', 64),
        ('io_out_memTrigger_tEnableVec_0', 'output', 1),
        ('io_out_memTrigger_tEnableVec_1', 'output', 1),
        ('io_out_memTrigger_tEnableVec_2', 'output', 1),
        ('io_out_memTrigger_tEnableVec_3', 'output', 1),
        ('io_out_memTrigger_debugMode', 'output', 1),
        ('io_out_memTrigger_triggerCanRaiseBpExp', 'output', 1),
        ('io_out_frontendTrigger_tUpdate_valid', 'output', 1),
        ('io_out_frontendTrigger_tUpdate_bits_addr', 'output', 2),
        ('io_out_frontendTrigger_tUpdate_bits_tdata_matchType', 'output', 2),
        ('io_out_frontendTrigger_tUpdate_bits_tdata_select', 'output', 1),
        ('io_out_frontendTrigger_tUpdate_bits_tdata_action', 'output', 4),
        ('io_out_frontendTrigger_tUpdate_bits_tdata_chain', 'output', 1),
        ('io_out_frontendTrigger_tUpdate_bits_tdata_tdata2', 'output', 64),
        ('io_out_frontendTrigger_tEnableVec_0', 'output', 1),
        ('io_out_frontendTrigger_tEnableVec_1', 'output', 1),
        ('io_out_frontendTrigger_tEnableVec_2', 'output', 1),
        ('io_out_frontendTrigger_tEnableVec_3', 'output', 1),
        ('io_out_frontendTrigger_debugMode', 'output', 1),
        ('io_out_frontendTrigger_triggerCanRaiseBpExp', 'output', 1),
        ('io_out_hasDebugTrap', 'output', 1),
        ('io_out_hasDebugIntr', 'output', 1),
        ('io_out_hasSingleStep', 'output', 1),
        ('io_out_triggerEnterDebugMode', 'output', 1),
        ('io_out_hasDebugEbreakException', 'output', 1),
        ('io_out_breakPoint', 'output', 1),
        ('io_out_criticalErrorStateEnterDebug', 'output', 1),
    ),
    'MemTrigger': (
        ('tdataVec_io_fromCsrTrigger_tdataVec_0_matchType', 'input', 2),
        ('tdataVec_io_fromCsrTrigger_tdataVec_0_select', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_0_timing', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_0_action', 'input', 4),
        ('tdataVec_io_fromCsrTrigger_tdataVec_0_chain', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_0_load', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_0_tdata2', 'input', 64),
        ('tdataVec_io_fromCsrTrigger_tdataVec_1_matchType', 'input', 2),
        ('tdataVec_io_fromCsrTrigger_tdataVec_1_select', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_1_timing', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_1_action', 'input', 4),
        ('tdataVec_io_fromCsrTrigger_tdataVec_1_chain', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_1_load', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_1_tdata2', 'input', 64),
        ('tdataVec_io_fromCsrTrigger_tdataVec_2_matchType', 'input', 2),
        ('tdataVec_io_fromCsrTrigger_tdataVec_2_select', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_2_timing', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_2_action', 'input', 4),
        ('tdataVec_io_fromCsrTrigger_tdataVec_2_chain', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_2_load', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_2_tdata2', 'input', 64),
        ('tdataVec_io_fromCsrTrigger_tdataVec_3_matchType', 'input', 2),
        ('tdataVec_io_fromCsrTrigger_tdataVec_3_select', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_3_timing', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_3_action', 'input', 4),
        ('tdataVec_io_fromCsrTrigger_tdataVec_3_chain', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_3_load', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_3_tdata2', 'input', 64),
        ('tdataVec_io_fromCsrTrigger_tEnableVec_0', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tEnableVec_1', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tEnableVec_2', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tEnableVec_3', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_debugMode', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_triggerCanRaiseBpExp', 'input', 1),
        ('tdataVec_io_fromLoadStore_vaddr', 'input', 50),
        ('tdataVec_io_fromLoadStore_isVectorUnitStride', 'input', 1),
        ('tdataVec_io_fromLoadStore_mask', 'input', 16),
        ('tdataVec_io_toLoadStore_triggerAction', 'output', 4),
        ('tdataVec_io_toLoadStore_triggerVaddr', 'output', 50),
        ('tdataVec_io_toLoadStore_triggerMask', 'output', 16),
        ('tdataVec_io_isPrf', 'input', 1),
    ),
    'MemTrigger_3': (
        ('tdataVec_io_fromCsrTrigger_tdataVec_0_matchType', 'input', 2),
        ('tdataVec_io_fromCsrTrigger_tdataVec_0_select', 'input', 1),
        ...
        ('tdataVec_io_fromCsrTrigger_tdataVec_0_action', 'input', 4),
        ('tdataVec_io_fromCsrTrigger_tdataVec_0_chain', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_0_store', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_0_tdata2', 'input', 64),
        ('tdataVec_io_fromCsrTrigger_tdataVec_1_matchType', 'input', 2),
        ('tdataVec_io_fromCsrTrigger_tdataVec_1_select', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_1_timing', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_1_action', 'input', 4),
        ('tdataVec_io_fromCsrTrigger_tdataVec_1_chain', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_1_store', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_1_tdata2', 'input', 64),
        ('tdataVec_io_fromCsrTrigger_tdataVec_2_matchType', 'input', 2),
        ('tdataVec_io_fromCsrTrigger_tdataVec_2_select', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_2_timing', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_2_action', 'input', 4),
        ('tdataVec_io_fromCsrTrigger_tdataVec_2_chain', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_2_store', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_2_tdata2', 'input', 64),
        ('tdataVec_io_fromCsrTrigger_tdataVec_3_matchType', 'input', 2),
        ('tdataVec_io_fromCsrTrigger_tdataVec_3_select', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_3_timing', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_3_action', 'input', 4),
        ('tdataVec_io_fromCsrTrigger_tdataVec_3_chain', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_3_store', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tdataVec_3_tdata2', 'input', 64),
        ('tdataVec_io_fromCsrTrigger_tEnableVec_0', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tEnableVec_1', 'input', 1),
        ('tdataVec_io_fromCsrTrigger_tEnableVec_2', 'input', 1),
