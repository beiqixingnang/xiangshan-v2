...
SOURCE_PATHS: tuple[str, ...] = (
    "upstream/src/main/scala/xiangshan/cache/dcache/meta/AsynchronousMetaArray.scala",
)
...
LOCKED_PORT_SPECS: dict[str, tuple[tuple[str, str, int], ...]] = {
    "L1CohMetaArray": (
        ...
        (
            "io_resp_0_0_coh_state",
            "output",
            2,
        ),
        (
            "io_resp_0_1_coh_state",
            "output",
            2,
        ),
        (
            "io_resp_0_2_coh_state",
            "output",
            2,
        ),
        (
            "io_resp_0_3_coh_state",
            "output",
            2,
        ),
        (
            "io_resp_1_0_coh_state",
            "output",
            2,
        ),
        (
            "io_resp_1_1_coh_state",
            "output",
            2,
        ),
        (
            "io_resp_1_2_coh_state",
            "output",
            2,
        ),
        (
        ...
        (
            "io_resp_2_0_coh_state",
            "output",
            2,
        ),
        (
            "io_resp_2_1_coh_state",
            "output",
            2,
        ),
        (
            "io_resp_2_2_coh_state",
            "output",
            2,
        ),
        (
            "io_resp_2_3_coh_state",
            "output",
            2,
        ),
        (
        ...
        (
            "io_resp_3_1_coh_state",
            "output",
            2,
        ),
        (
            "io_resp_3_2_coh_state",
            "output",
            2,
        ),
        (
            "io_resp_3_3_coh_state",
            "output",
            2,
        ),
        (
        ...
        (
            "io_write_0_bits_way_en",
            "input",
            4,
        ),
        (
            "io_write_0_bits_meta_coh_state",
            "input",
            2,
        ),
    ),
    "L1ErrorMetaArray": (
        ...
        (
            "io_resp_0_0_tl_denied",
            "output",
            1,
        ),
        (
            "io_resp_0_0_tl_corrupt",
            "output",
            1,
        ),
        (
            "io_resp_0_1_tl_denied",
            "output",
            1,
        ),
        (
            "io_resp_0_1_tl_corrupt",
            "output",
            1,
        ),
        (
            "io_resp_0_2_tl_denied",
            "output",
            1,
        ),
        (
            "io_resp_0_2_tl_corrupt",
            "output",
            1,
        ),
        (
            "io_resp_0_3_tl_denied",
            "output",
            1,
        ),
        (
            "io_resp_0_3_tl_corrupt",
            "output",
            1,
        ),
        (
            "io_resp_1_0_tl_denied",
            "output",
            1,
        ),
        (
            "io_resp_1_0_tl_corrupt",
            "output",
            1,
        ),
        (
            "io_resp_1_1_tl_denied",
            "output",
            1,
        ),
        (
            "io_resp_1_1_tl_corrupt",
            "output",
            1,
        ),
        (
            "io_resp_1_2_tl_denied",
            "output",
            1,
        ),
        (
            "io_resp_1_2_tl_corrupt",
            "output",
            1,
        ),
        (
            "io_resp_1_3_tl_denied",
            "output",
            1,
        ),
        (
            "io_resp_1_3_tl_corrupt",
            "output",
            1,
        ),
        (
            "io_resp_2_0_tl_denied",
            "output",
            1,
        ),
        (
            "io_resp_2_0_tl_corrupt",
            "output",
            1,
        ),
        (
            "io_resp_2_1_tl_denied",
            "output",
            1,
        ),
        (
            "io_resp_2_1_tl_corrupt",
            "output",
            1,
        ),
        (
            "io_resp_2_2_tl_denied",
            "output",
            1,
        ),
        (
            "io_resp_2_2_tl_corrupt",
            "output",
            1,
        ),
        (
            "io_resp_2_3_tl_denied",
            "output",
            1,
        ),
        (
            "io_resp_2_3_tl_corrupt",
            "output",
            1,
        ),
        (
            "io_resp_3_0_tl_denied",
            "output",
            1,
        ),
        (
            "io_resp_3_0_tl_corrupt",
            "output",
            1,
        ),
        (
            "io_resp_3_1_tl_denied",
            "output",
            1,
        ),
        (
            "io_resp_3_1_tl_corrupt",
            "output",
            1,
        ),
        (
            "io_resp_3_2_tl_denied",
            "output",
            1,
        ),
        (
            "io_resp_3_2_tl_corrupt",
            "output",
            1,
        ),
        (
            "io_resp_3_3_tl_denied",
            "output",
            1,
        ),
        (
            "io_resp_3_3_tl_corrupt",
            "output",
            1,
        ),
        (
        ...
        (
            "io_write_0_bits_error_tl_denied",
            "input",
            1,
        ),
        (
            "io_write_0_bits_error_tl_corrupt",
            "input",
            1,
        ),
    ),
    "L1FlagMetaArray": (
        ...
        (
            "io_write_3_bits_way_en",
            "input",
            4,
        ),
        (
            "io_write_3_bits_flag",
            "input",
            1,
        ),
    ),
