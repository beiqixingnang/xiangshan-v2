...
class CoupledL2Slice(Elaboratable):
    ...
    def elaborate(self, platform: Any) -> Module:
        ...
        m.d.comb += [
            ...
            self.out_e_bits_sink.eq(0), self.out_d_bits_opcode.eq(0), self.out_d_bits_param.eq(0),
            self.out_d_bits_size.eq(0), self.out_d_bits_source.eq(0), self.out_d_bits_sink.eq(0),
            self.out_d_bits_denied.eq(0), self.out_d_bits_echo_blockisdirty.eq(0), self.out_d_bits_data.eq(0),
            self.out_d_bits_corrupt.eq(0),
